...
#from keras.layers.merge import add, concatenate, dot  # in keras 2
...
#from keras.utils.layer_utils import layer_from_config  # removed in keras 2
...
def insert_layer(model, new_layer, index):
    ...
    for i,layer in enumerate(model.layers):
        ...
        copied = layers.deserialize(wrap_config(layer))
        res.add(copied)
